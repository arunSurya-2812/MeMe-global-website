      ...
      <footer class="footer">
        {/* <Container> */}
          <Row>
            ...
            <Col lg={3} sm={4} md={3} xs={12}style={{ marginTop: "15px",fontFamily:"Poppins" }}>
            ...
            <Col  md={3} lg={3} style={{ marginTop: "15px",fontFamily:"Poppins"  }}>  <div class="w-100"></div>
              <strong>Phone:</strong>9150041898
              <div class="w-100"></div>
              <strong>Email:</strong>
              <div class="w-100"></div>
              <strong>Open Time:</strong>
              <span>8AM - 6:00PM</span></Col>
            <Col lg={3} sm={4} md={3} xs={12}style={{ marginTop: "15px",fontFamily:"Poppins"  }}>
